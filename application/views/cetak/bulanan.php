...
<body onload="window.print();">
  <h4><center> REKAPITULASI BULANAN CAPAIAN PRESTASI KERJA ASN <br> PEMERINTAH KABUPATEN MANOKWARI </center></h4>
  ...
  <div class="table">
    <table>
      <thead>
        <tr>
          <th class="col1">No</th>
          <th class="col2">Hari/Tanggal</th>
          <th class="col3">Jumlah Waktu Kerja Terpakai</th>
          <th class="col4">Keterangan Kehadiran</th>
          <th class="col5">Ket</th>
        </tr>
      </thead>
       <tbody>
        <tr class="datar">
